...
export function Login() {
	...
	function loginRegister() {
		if (register) {
			chatService.send(
				{ type: "register", email, password, displayName, staySignedIn: true }
			);
		}
		else {
			chatService.send(
				{ type: "login", email, password, staySignedIn: true }
			);
		}
	}
	...
	return <div class="Login">
		...
		{
			register ?
				<button type="button" onClick={loginRegister}>Register</button> :
